...
class JogoDaVelhaState extends State<JogoDaVelha> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromRGBO(0, 0, 44, 1.0),
      body: SafeArea(
          child: Stack(
        children: <Widget>[
          Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: Imagens.fundoJogoVelha.image,
                fit: BoxFit.cover,
              ),
            ),
          ),
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        Navigator.pushNamedAndRemoveUntil(context, '/telaJogos',
