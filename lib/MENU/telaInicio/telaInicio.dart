...
class TelaInicioState extends State<TelaInicio> {
  ...
  void initState() {
    ...
    Imagens.fundoJogoVelha = Image.asset("assets/telaJogos/fundoJogos/jogoVelha/fundoJogoVelha.png");
    Imagens.fundoSelecaoOrdenarNumeros = Image.asset("assets/telaJogos/fundoJogos/ordenarNumeros/fundoSelecaoOrdenarNumeros.png");
    Imagens.fundoJogoOrdenarNumeros = Image.asset("assets/telaJogos/fundoJogos/ordenarNumeros/fundoJogoOrdenarNumeros.png");
    Timer(
        Duration(seconds: 5),
  ...
  void didChangeDependencies() {
    ...
    precacheImage(Imagens.fundoJogoVelha.image, context);
    precacheImage(Imagens.fundoSelecaoOrdenarNumeros.image, context);
    precacheImage(Imagens.fundoJogoOrdenarNumeros.image, context);
  }
